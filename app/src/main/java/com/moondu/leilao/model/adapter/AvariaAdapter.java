...
import com.moondu.leilao.view.fragment.checkin.CarDamage;

import java.util.List;

public class AvariaAdapter extends MaxHeightRecyclerView.Adapter<AvariaAdapter.ViewHolder> {

    private List<String> itens;
    private CarDamage fragment;


    public AvariaAdapter(CarDamage fragment, List<String> itens) {
        this.itens = itens;
