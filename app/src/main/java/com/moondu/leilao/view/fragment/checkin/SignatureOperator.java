...
public class SignatureOperator extends BaseFragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        getActivity().setTitle(R.string.menu_signature_operator);
    ...
    public void onBackPressed() {
        ...
        SignatureDriver fragment = new SignatureDriver();
    ...
    private void save() {
        if (!signaturePad.isEmpty()) {
            ...
            try {
                String name = "Signature_Operator.jpg";
            ...
            query.addListenerForSingleValueEvent(new ValueEventListener() {
                ...
                public void onDataChange(DataSnapshot dataSnapshot) {
                    ...
                    SignatureOfficial fragment = new SignatureOfficial();
                    fragment.setArguments(bundle);
